...
import org.apache.pulsar.client.api.{Authentication, Schema}
...
object S3ToAstraDBMigrator {
    ...
    def main(args: Array[String]): Unit = {
        ...
        //val config = PulsarClientConfig("pulsar://localhost:6650", false, Authentication)
        //val client = PulsarClient(config)

        //implicit val schema: Schema[DeviceTS] = Schema.AVRO(DeviceTS.getClassSchema)
